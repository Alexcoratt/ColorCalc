...
AutoValue::operator std::string() const { return std::string(*_value); }
AutoValue::operator double() const { return double(*_value); }
AutoValue::operator int() const { return int(*_value); }
